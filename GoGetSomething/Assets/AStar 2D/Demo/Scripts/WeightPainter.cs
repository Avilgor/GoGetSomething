...
{
    /// <summary>
    /// Used in the weighting demo to allow the user to easily modify node weighting values by using a terrain like paining system.
    /// </summary>
                ...
                if(Input.GetMouseButton(0) == true)
                {
                    ...
                    foreach(Collider2D collider in colliders)
                    {
                        ...
                        if(linearFalloff == true)
                        {
                            ...
                            float distance = Vector2.Distance(tile.WorldPosition, mouseWorldPos);
