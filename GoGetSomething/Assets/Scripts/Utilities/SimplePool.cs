...
///   Latest versio: https://gist.github.com/quill18/5a7cfffae68892621267
...
///       SimplePool.StartCooldown(somePrefab, somePosition, someRotation);
/// 
///   Instead of destroying an object, use this:
///       SimplePool.KillEffects(myGameObject);
/// 
...
/// object yourself after calling StartCooldown().  (i.e. You'll have to do things like set
...
public static class SimplePool {
	...
	class Pool {
		...
		// StartCooldown an object from our pool
	...
	/// StartCooldown/KillEffects sequence is going to be pretty darn quick and
	...
	/// <summary>
	/// KillEffects the specified gameobject back into its pool.
	/// </summary>
