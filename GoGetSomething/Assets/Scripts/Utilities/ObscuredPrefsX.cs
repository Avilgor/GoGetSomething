...
public class ObscuredPrefsX
{
    ...
    public static bool SetBool(String name, bool value)
    {
        try
        {
            ObscuredPrefs.SetInt(name, value ? 1 : 0);
        }
        catch
        {
            return false;
    ...
    {
        return ObscuredPrefs.GetInt(name) == 1;
    }

    public static bool GetBool(String name, bool defaultValue)
    {
        return (1 == ObscuredPrefs.GetInt(name, defaultValue ? 1 : 0));
    }
    ...
    public static long GetLong(string key, long defaultValue)
    {
        ...
        lowBits = ObscuredPrefs.GetInt(key + "_lowBits", lowBits);
        highBits = ObscuredPrefs.GetInt(key + "_highBits", highBits);
    ...
    {
        int lowBits = ObscuredPrefs.GetInt(key + "_lowBits");
        int highBits = ObscuredPrefs.GetInt(key + "_highBits");
    ...
    public static void SetLong(string key, long value)
    {
        ...
        ObscuredPrefs.SetInt(key + "_lowBits", lowBits);
        ObscuredPrefs.SetInt(key + "_highBits", highBits);
    }
    ...
    public static String[] GetStringArray(String key)
    {
        if (ObscuredPrefs.HasKey(key))
        {
            var completeString = ObscuredPrefs.GetString(key);
    ...
    private static bool SaveBytes(String key, byte[] bytes)
    {
        try
        {
            ObscuredPrefs.SetString(key, System.Convert.ToBase64String(bytes));
        }
        catch
        {
            return false;
